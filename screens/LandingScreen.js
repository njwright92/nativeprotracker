  ...
  return (
    <ScrollView style={styles.scrollView}>
      <View style={styles.viewStyles}>
        ...
        <Image
          source={require("../assets/img/catchy.jpg")}
          style={styles.imagePlaceholder}
          load="lazy"
        />
        <Text style={styles.subHeading}>Why Native Pro Tracker?</Text>
        <Text style={styles.infoText}>
          Imagine an app that's your ultimate wingman for managing tasks and
          products. That's us. Real-time updates, military-grade security, and
          super-fast on all your devices. And yeah, we run on Google Cloud so
          you know we're legit.
        </Text>
        <Image
          source={require("../assets/img/business.jpg")}
          style={styles.imagePlaceholder}
          load="lazy"
        />
        <Text style={styles.infoText}>
          From small businesses to personal projects, Native Pro Tracker is your
          go-to. Keep an eye on your inventory, plan your day, or track your
          personal projects; do it all effortlessly.
        </Text>
        ...
        <Text style={styles.infoText}>
          Track the production and inventory of whatever you produce. Stay ahead
          of your business operations in real-time.
        </Text>
        <Image
        ...
        <Text style={styles.infoText}>
          Keep track of tasks, projects, and items to help you be organized on
          the go. Simplify your life one tap at a time.
        </Text>
        <Image
