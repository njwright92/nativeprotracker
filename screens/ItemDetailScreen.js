...
const ItemDetailScreen = ({ route }) => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = getAllEntriesByCurrentUser(
      itemParam.id,
      handleEntriesUpdate
    );
    return () => {
    ...
    <View style={styles.container}>
      ...
      <View style={styles.listContainer}>
        ...
        <FlatList
          ...
          extraData={entries}
          ListEmptyComponent={
            <Text style={styles.entryText}>No Entries Found</Text>
          }
      ...
      >
        Select below to view Line Charts and download data "CSV or PDF"
      </Text>
      <TouchableOpacity
        style={styles.card}
        onPress={() => {
